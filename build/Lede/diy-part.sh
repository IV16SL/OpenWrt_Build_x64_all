...
sed -i '/<tr><td width="33%"><%:CPU usage/a <tr><td width="33%"><%:Compiler author%></td><td><a target="_blank" href="https://blog.iv16sl.xyz">【IV16SL的博客】https://blog.iv16sl.xyz</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
sed -i '/<tr><td width="33%"><%:Compiler author/a <tr><td width="33%"><%:Firmware Update%></td><td><a target="_blank" href="https://pan.iv16sl.xyz">点这里下载最新版本</a></td></tr>' package/lean/autocore/files/x86/index.htm
...
export Customized_Information="OpenWrt_x64 $(TZ=UTC-8 date "+%Y.%m.%d")"  # 个性签名,你想写啥就写啥，(填0为不作修改)
